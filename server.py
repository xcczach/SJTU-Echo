...
if __name__ == "__main__":
    ...
    parser.add_argument("--chat-model", type=str, default="Qwen/Qwen2.5-1.5B-Instruct-AWQ")
    ...
    launch_server(args.chat_model, args.vectorstore_source_dir, args.port, args.llm_gpu_memory_utilization)
